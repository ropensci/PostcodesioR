...
test_that("outcode_reverse_geocoding works as expected", {
  ...
  expect_error(outcode_reverse_geocoding(-3.15, 51.47, limit = 101, radius = 20000))
  expect_error(outcode_reverse_geocoding(-3.15, 51.47, limit = 11, radius = 3000))
  expect_error(outcode_reverse_geocoding(-3.15, 51.47, limit = 11, radius = 25001))
